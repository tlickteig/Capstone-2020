...
Date: 2/18/2020
Comment: Test records for product
*/
...
Created by: Robert Holmes
Date: 2/18/2020
Comment: Table for holding product types.
*/
...
Created by: Robert Holmes
Date: 2/18/2020
Comment: Table for holding product categories.
*/
...
CREATE TABLE [dbo].[ProductCategory](
	...
	,	[Description]		[NVARCHAR](500)	NOT NULL
	,	CONSTRAINT	[pk_ProductCategoryID]	PRIMARY KEY([ProductCategoryID] ASC)
)
GO
...
Created by: Robert Holmes
Date: 2/18/2020
Comment: Table for holding information relevant to a single product
*/
...
CREATE TABLE [dbo].[Product](
	...
	,	CONSTRAINT	[fk_ProductCategory_ProductCategoryID]	FOREIGN KEY([ProductCategory])
			REFERENCES	[ProductCategory]([ProductCategoryID])
	,	CONSTRAINT	[fk_ProductType_ProductTypeID]			FOREIGN KEY([ProductType])
...
AS
	...
	SELECT		[ProductID]
			...
			,	[Taxable]
	FROM	[dbo].[Product]
	WHERE	[ProductType] LIKE @ProductTypeID
END
GO
...
Created by: Robert Holmes
Date: 2/18/2020
Comment: Test records for item.
*/
print '' print '*** Inserting test items to Item table' 
GO
...
Created by: Robert Holmes
Date: 2/18/2020
Comment: Test records for product category.
*/
print '' print '*** Inserting test categories to ProductCategory table'
GO
INSERT INTO [dbo].[ProductCategory]
	([ProductCategoryID], [Description])
	VALUES
...
Created by: Robert Holmes
Date: 2/18/2020
Comment: Test records for product type.
*/
print '' print '*** Inserting test types to ProductType table'
GO
INSERT INTO [dbo].[ProductType]
	([ProductTypeID], [Description])
	VALUES
	("Test Type", "Test type description")
GO
...
Comment: Test records for product.
*/
print '' print '*** Inserting test products to Product table'
GO
INSERT INTO [dbo].[Product]
	([ProductID], [ItemID], [ProductName], [ProductCategory], [ProductType], [Description], [Price], [Brand])
	VALUES
		("1234567890120", 0, "Test Product 1", "Test Category", "Test Type", "Test product number 1 description", 1.12, "Brand")
	,	("1234567890121", 1, "Test Product 2", "Test Category", "Test Type", "Test product number 2 description", 1.50, "Royal Canin")
	,	("1234567890122", 2, "Test Product 2", "Test Category", "Test Type", "Test product number 3 description", 1.75, "Merrick")
GO
...
Created by: Robert Holmes
Date: 2/18/2020
Comment: Table for holding information about transaction statuses
*/
print '' print '*** Creating transaction status table'
GO
CREATE TABLE [dbo].[TransactionStatus](
		TransactionStatusID	[NVARCHAR](20)	NOT NULL
	,	Description			[NVARCHAR](500)	NOT NULL
	,	CONSTRAINT [pk_TransactionStatusID]	PRIMARY KEY([TransactionStatusID] ASC)
)
GO
...
Created by: Robert Holmes
Date: 2/18/2020
Comment: Table for holding information about transaction types
*/
print '' print '*** Creating transaction type table'
GO
CREATE TABLE [dbo].[TransactionType](
		TransactionTypeID	[NVARCHAR](20)	NOT NULL
	,	Description			[NVARCHAR](500)	NOT NULL
	, 	CONSTRAINT [pk_TransactionTypeID] PRIMARY KEY ([TransactionTypeID] ASC)
)
GO	
...
Created by: Robert Holmes
Date: 2/20/2020
Comment: Inserting types of transactions
*/
print '' print '***Inserting TransactionType values'
GO
INSERT INTO [dbo].[TransactionType]
	([TransactionTypeID], [Description])
	VALUES
	('Cash', 'A transaction that involved physical currency')
GO

/*
Created by: Robert Holmes
Date: 2/18/2020
Comment: Table for holding information about transactions
*/
print '' print '*** Creating cTransaction table'
GO
CREATE TABLE [dbo].[cTransaction](
	...
	,	CONSTRAINT [fk_cTransaction_User] FOREIGN KEY ([EmployeeID])
			REFERENCES [User]([UserID])
	,	CONSTRAINT [fk_cTransaction_TransactionStatus] FOREIGN KEY ([TransactionStatus])
			REFERENCES [TransactionStatus]([TransactionStatusID])
	,	CONSTRAINT [fk_cTransaction_TransactionType] FOREIGN KEY ([TransactionType])
...
Created by: Robert Holmes
Date: 2/18/2020
Comment: Table for holding lines related to transactions.
*/
...
CREATE TABLE [dbo].[TransactionLine](
	...
	, 	CONSTRAINT [pk_TransactionID_ProductID] PRIMARY KEY ([TransactionID],[ProductID] ASC)
	,	CONSTRAINT [fk_TransactionLine_Transaction] FOREIGN KEY ([TransactionID])
			REFERENCES [cTransaction]([TransactionID])
	,	CONSTRAINT [fk_TransactionLine_Product] FOREIGN KEY ([ProductID])
